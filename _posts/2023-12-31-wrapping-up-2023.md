...
image: 2023.png # default: default.png
alt: 
---
...
<img class="is-hidden-mobile" width="50%" height="auto" src="{{ site.url }}{{ site.baseurl }}{{ site.image_src }}22.png">
<img class="is-hidden-widescreen" src="{{ site.url }}{{ site.baseurl }}{{ site.image_src }}22.png">
<p>SocialBlade subscriber graph for Lynxmic as of 31 December 2023.</p>
</div>
<br>
<div style="text-align: center;">
<img class="is-hidden-mobile" width="50%" height="auto" src="{{ site.url }}{{ site.baseurl }}{{ site.image_src }}2023 YouTube snapshot for Lynxmic and MoreLynxmic.png">
<img class="is-hidden-widescreen" src="{{ site.url }}{{ site.baseurl }}{{ site.image_src }}2023 YouTube snapshot for Lynxmic and MoreLynxmic.png">
<p>YouTube snapshots. Data is only up to 30 November 2023.</p>
</div>
...
<div style="text-align: center;">
<img class="is-hidden-mobile" width="50%" height="auto" src="{{ site.url }}{{ site.baseurl }}{{ site.image_src }}19.png">
<img class="is-hidden-widescreen" src="{{ site.url }}{{ site.baseurl }}{{ site.image_src }}19.png">
<p>A (bad ik) representation of the 2023 Lynxmic branding package.</p>
</div>
